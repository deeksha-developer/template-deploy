  ...
  return (
    <div
      className="z-50 rounded-3xl border border-[#ffffff0d] flex flex-col items-center justify-center p-4 sm:p-6 w-full max-w-xs sm:w-[262px] sm:h-[157px] bg-white/80 shadow-lg transition-all duration-300
        sm:absolute sm:top-0 sm:left-[585px] relative mx-auto mt-2"
      style={{
        background: darkMode
    ...
    >
      <div className="flex items-center">
        ...
        <button
          ...
          className="w-[92px] h-[56px] flex items-center rounded-full p-1 transition-colors duration-300 border border-[#ffffff1a] bg-[#10092b40] relative focus:outline-none"
          style={{ minWidth: 70 }}
          aria-label="Toggle dark mode"
        >
          <div
            className={`w-[46px] h-[46px] rounded-full bg-gradient-to-br from-[#faae6b] to-[#c84350] flex items-center justify-center shadow-md transform duration-300 ease-in-out absolute top-1 left-1 transition-transform ${
